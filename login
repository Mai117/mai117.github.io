...
<html>
  ...
  <body>
    ...
    <div class="top-wrapper">
      <div class="container">
        <h1>教員の教員による教員のためのサイト</h1>
        <h1>より効果的で楽しい指導案を！</h1>
        <p>teachersは教員のための教材や指導案をシェアするサイトです。</p>
        <p>自分の作成した教材や指導案をシェアし、新たな教材や指導案を手に入れましょう。</p>
    ...
    <div class="message-wrapper">
      <div class="container">
        <div class="heading">
          <h2>さぁ、あなたもteachersで効果的な教材や指導案を手に入れませんか?</h2>
          <h3>Let's join us, create more efective education!</h3>
        </div>
    ...
    <footer>
      <div class="container">
        <a href="#" class="home">teachers</a>
        <p>Share your lesson plan and idea!</p>
      </div>
    </footer>
  </body>
